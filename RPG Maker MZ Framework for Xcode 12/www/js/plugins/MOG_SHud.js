...
/*:
 * @plugindesc (v1.3) Apresenta uma Hud com a quantidade mp em cima do personagem.
 * @author Moghunter
 *
 ...
 * =============================================================================
 * Apresenta uma Hud com a quantidade mp em cima do personagem.
...
// * Need Refresh mp
//==============================
S_Hud.prototype.needRefreshmp = function() {
...
// * refreshmp
//==============================
S_Hud.prototype.refreshmp = function() {	
     this._old_mp = [this.battler().mp,this.battler().mmp];
	 var rate = this._meter_img.width * this.battler().mp / this.battler().mmp;
...
S_Hud.prototype.update_meter = function() {
	 if (this.needRefreshmp()) {this.refreshmp()};
};
